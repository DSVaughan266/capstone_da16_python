# Tennessee Postsecondary ROI Analysis
...
National Center for Education Statistics - IPEDS c2024\_A completions data
...
I chose to use 5-year post-program earnings data.

First, I investigated Return on Investment and Recovery Years for broad programs and then for specific areas of study.
...
Certificate programs offer rapid workforce entry and minimal time to recover program costs.

Associate programs offer a balanced path with many stable career choices available.

Bachelor programs take much longer to recover, but correspond to higher average long term earnings.



The key insight was that, if carefully chosen, each degree level has both outstanding and less than spectacular options. A well chosen certificate or associate program can outperform many bachelor degrees. I also discovered that while some broad subject areas may appear to perform well, specific courses of study may over or under achieve.
